...
func init() {
	proto.RegisterType((*String)(nil), "raceRpc.String")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x2f, 0x4a, 0x4c, 0x4e, 0x0d, 0x2a, 0x48,
	0x56, 0x92, 0xe3, 0x62, 0x0b, 0x2e, 0x29, 0xca, 0xcc, 0x4b, 0x17, 0x12, 0xe1, 0x62, 0x2d, 0x4b,
	0xcc, 0x29, 0x4d, 0x95, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x70, 0x8c, 0xb2, 0xb8, 0x78,
	0x3c, 0x40, 0xfa, 0x82, 0x53, 0x8b, 0xca, 0x32, 0x93, 0x53, 0x85, 0x34, 0xb9, 0x58, 0xc1, 0x7c,
	0x21, 0x7e, 0x3d, 0xa8, 0x11, 0x7a, 0x10, 0xfd, 0x52, 0xe8, 0x02, 0x42, 0xfa, 0x5c, 0xec, 0xce,
	0x19, 0x89, 0x79, 0x79, 0xa9, 0x39, 0x84, 0x15, 0x6b, 0x30, 0x1a, 0x30, 0x26, 0xb1, 0x81, 0xdd,
	0x66, 0x0c, 0x08, 0x00, 0x00, 0xff, 0xff, 0x87, 0x2b, 0x94, 0x03, 0xaa, 0x00, 0x00, 0x00,
}
...
func (c *helloServiceClient) Hello(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/raceRpc.HelloService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/raceRpc.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/raceRpc.HelloService/Hello",
	}
...
var _HelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "raceRpc.HelloService",
