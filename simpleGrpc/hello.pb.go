...
func init() {
	proto.RegisterType((*String)(nil), "simple.String")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0x62, 0x2b, 0xce, 0xcc, 0x2d, 0xc8, 0x49, 0x55,
	0x92, 0xe3, 0x62, 0x0b, 0x2e, 0x29, 0xca, 0xcc, 0x4b, 0x17, 0x12, 0xe1, 0x62, 0x2d, 0x4b, 0xcc,
	0x29, 0x4d, 0x95, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82, 0x70, 0x8c, 0xd2, 0xb8, 0x78, 0x3c,
	0x40, 0xda, 0x82, 0x53, 0x8b, 0xca, 0x32, 0x93, 0x53, 0x85, 0xd4, 0xb9, 0x58, 0xc1, 0x7c, 0x21,
	0x3e, 0x3d, 0x88, 0x09, 0x7a, 0x10, 0xed, 0x52, 0x68, 0x7c, 0x21, 0x5d, 0x2e, 0x76, 0xe7, 0x8c,
	0xc4, 0xbc, 0xbc, 0xd4, 0x1c, 0x42, 0x4a, 0x35, 0x18, 0x0d, 0x18, 0x93, 0xd8, 0xc0, 0xce, 0x32,
	0x06, 0x04, 0x00, 0x00, 0xff, 0xff, 0xdf, 0x6a, 0x89, 0x76, 0xa5, 0x00, 0x00, 0x00,
}
...
func (c *helloServiceClient) Hello(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/simple.HelloService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/simple.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/simple.HelloService/Hello",
	}
...
var _HelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "simple.HelloService",
