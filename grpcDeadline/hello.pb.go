...
func init() {
	proto.RegisterType((*String)(nil), "grpcDeadline.String")
}
...
var fileDescriptor_61ef911816e0a8ce = []byte{
	...
	0xc9, 0xd7, 0x2b, 0x28, 0xca, 0x2f, 0xc9, 0x17, 0xe2, 0x49, 0x2f, 0x2a, 0x48, 0x76, 0x49, 0x4d,
	0x4c, 0xc9, 0xc9, 0xcc, 0x4b, 0x55, 0x92, 0xe3, 0x62, 0x0b, 0x2e, 0x29, 0xca, 0xcc, 0x4b, 0x17,
	0x12, 0xe1, 0x62, 0x2d, 0x4b, 0xcc, 0x29, 0x4d, 0x95, 0x60, 0x54, 0x60, 0xd4, 0xe0, 0x0c, 0x82,
	0x70, 0x8c, 0xea, 0xb8, 0x78, 0x3c, 0x40, 0x9a, 0x83, 0x53, 0x8b, 0xca, 0x32, 0x93, 0x53, 0x85,
	0x8c, 0xb9, 0x58, 0xc1, 0x7c, 0x21, 0x11, 0x3d, 0x64, 0x73, 0xf4, 0x20, 0x86, 0x48, 0x61, 0x15,
	0x15, 0xb2, 0xe4, 0x62, 0x77, 0xce, 0x48, 0xcc, 0xcb, 0x4b, 0xcd, 0x21, 0x45, 0x9b, 0x06, 0xa3,
	0x01, 0x63, 0x12, 0x1b, 0xd8, 0xd1, 0xc6, 0x80, 0x00, 0x00, 0x00, 0xff, 0xff, 0x92, 0xd4, 0x9f,
	0x2e, 0xc3, 0x00, 0x00, 0x00,
}
...
func (c *helloServiceClient) Hello(ctx context.Context, in *String, opts ...grpc.CallOption) (*String, error) {
	out := new(String)
	err := c.cc.Invoke(ctx, "/grpcDeadline.HelloService/Hello", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *helloServiceClient) Channel(ctx context.Context, opts ...grpc.CallOption) (HelloService_ChannelClient, error) {
	stream, err := c.cc.NewStream(ctx, &_HelloService_serviceDesc.Streams[0], "/grpcDeadline.HelloService/Channel", opts...)
	if err != nil {
		return nil, err
	}
...
func _HelloService_Hello_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/grpcDeadline.HelloService/Hello",
	}
...
var _HelloService_serviceDesc = grpc.ServiceDesc{
	ServiceName: "grpcDeadline.HelloService",
